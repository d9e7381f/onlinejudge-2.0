...
from apps.user.serializers import UserProfileSerializer, GroupSerializer
...
class ContestRetrieveSerializer(ContestAdminSerializer):
    ...
    def get_is_competitor(self, obj):
        """Whether a user is a competitor of a contest."""
        request = self.context['request']
        user = request.user
        return is_competitor(obj, user, request)
...
class ACMContestRankSerializer(serializers.ModelSerializer):
    ...
    userprofile = UserProfileSerializer(source='user.userprofile')
